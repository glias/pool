...
export const LIQUIDITY_ORDER_LOCK_CODE_HASH =
  process.env.LIQUIDITY_ORDER_LOCK_CODE_HASH || '0x9bd7e06f3ecf4be0f2fcd2188b23f1b9fcc88e5d4b65a8637b17723bbda3cce8';
...
export const LIQUIDITY_ORDER_LOCK_DEP = {
  outPoint: {
    txHash:
      ...
      '0xfc291a15698cb2eb08868c9761615a94e85dec49c1d7690a79cc2a8e536442ee',
    index: '0x0',
  },
  depType: 'code',
};
